...
function StatItem({ number, label, icon, delay, isVisible }) {
    return (
        <div 
        ...
        >
            ...
            <p className="text-white/70 max-w-sm">{label}</p>
        </div>
    );
}
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 relative">
                    ...
                    <div className="flex flex-col justify-between gap-20 pr-0 md:pr-16">
                        {/* Upper Left */}
                        <div className="mt-0 md:mt-32 border-b border-white/30 pt-8 pb-8">
                            <StatItem
                                number='100<span class="text-white/60">+</span>'
                                label="Site and Climate Analyses Conducted"
                                delay={200}
                                isVisible={isVisible}
                            />
                        </div>
                        ...
                        <div>
                            <StatItem
                                number='5.0<span class="text-white/60">%</span>'
                    ...
                    <div className="flex flex-col justify-between gap-20 pl-0 md:pl-16">
                        ...
                        <div className="max-sm:border-t border-b border-white/30 pb-10 md:pb-20">
                            <StatItem
                                number='10<span class="text-white/60">+</span>'
                                label="Active Design Studies"
                                icon={sparkleIcon}
                                delay={600}
                                isVisible={isVisible}
                            />
                        ...
                        <div className="border-b border-white/30 max-sm:-mt-20 pb-10 mb-0 md:mb-32">
                            <StatItem
                                number='<span class="text-white/60">&gt;</span>500'
