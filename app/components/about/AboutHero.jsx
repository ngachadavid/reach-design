  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="flex flex-col md:flex-row gap-6 2xl:gap-12 items-start mb-16">
          {/* Sticky Title */}
          ...
          {/* Content - Scrollable */}
          <div className="w-full md:w-[50%] 2xl:w-[60%] space-y-20">
            
            {/* Section 1: A New Vision for African Architecture */}
            <div>
              <h3 className="text-3xl 2xl:text-4xl font-extrabold tracking-tight">
                A New Vision for African Architecture
              </h3>
              <p className="mt-6 text-lg 2xl:text-xl leading-relaxed tracking-tight">
              ...
              <ul className="mt-4 list-disc list-inside space-y-3 text-base 2xl:text-lg">
                <li>
